    ...
    class Cloud{
        ...
        getSystemInfo() : SystemInformation{
            return {
                ...
                connectionStatus: this.isConnected() ? CloudStatus.CONNECTED : CloudStatus.NOT_CONNECTED
            }
        }
        printJSON(json: any, raw: any){
            ...
            if (engine.getBackend() == "ts3"){
                switch(raw.mode){
                    case 1: channelID = raw.client; break;
                    case 2: channelID = raw.channel; break;
                    default: channelID = raw.client; break;
                }
            }
            ...
            if (embed){
                backend.extended().createMessage(channelID, {
                    "embed": {
                    "footer": {
                        "text": `Auto generated by Support++ ${cloud.getSystemInfo().version}`
                        },
                      "color": 2305854,
                      "thumbnail": {
                        "url": "https://meta.support-pp.de/uploads/default/original/1X/c3d8807d8f6921324ddaab30637a2f86137cfbe1.png"
                      },
                      "fields": fields
                    }
                  })
...
//TESTAREA
    ...
    if (!command) console.log("500 - https://meta.support-pp.de/t/500-command-js/56", logtag.ERROR )
    ...
    const cloudCMD = command.createCommandGroup("cloud")
    .help("manages the Support++ cloud")

    cloudCMD.addCommand("info")
