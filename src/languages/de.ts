        ...
        return {
            lang: {
                manifest: {
                    ...
                    spGermanNotAvailable: 'Sorry :/ but German is not available. But in the next version 2.0.5',
                    spSupportChannels: {
                        title: 'Support Channels (*)',
                        vars: {
                            spSupportChannel: 'Select the support channel that users will enter when they need support (*)',
                            spSupporterId: 'Supporter servergroup ID (*)',
                            spSupportUserMessage: {
                                title: 'Message sent to the user when he joins the support channel (*)',
                                placeholder: 'Hello &u, please wait. A supporter has been informed [Variable &u = Username | &spI = Count of Online Supporter (int)]'
                            },
                            spSupportMessage: {
                    ...
                    spIgnoreId: 'Ignore servergroup ID (*)',
                    spAfkChannels: {
                        title: 'AFK Channels - ignore Supporter... (*)',
                        spAfkChannel: 'AFK Channel ignore Supporters. (*)',
                        spAfkChannelSub: 'Ignore all sub channels... (for big server)'
                    },
                    ...
                    spModule: 'Support++ module. Activate the module with the Checkbox.',
                    spAPIActive: '[Support++] Use a powerful cross-platform Support API.',
                    spInfoAPI: 'Why should I use an external API? That\'s a good question ... I\'ll explain it to you ... Check it out on the website https://support-pp.de/api',
                    spInfoAPI2: '[Disclaimer] The Support++ API is a external and independently API. it allows us to extend the script scope. Our API is developed under the highest privacy policy. Your data is secure thanks to AWS databases and accessible online at any time. However, we assume no liability for this API.',
                    spAPIToken: '[Support++ API] That\'s the only thing we want to know :) Please enter your API token from https://register.support-pp.de',
                    spMySQLActive: '[MySQL] Advanced storage for module',
                    spDBINFO: 'This module connects the SinusBot with your MySQL DB. The Module automatically creates all necessary tables for you.',
                    spHost: {
                    ...
                    spDBPROINFO: '[ i ] You don\'t have a MySQL DB? All PRO members receive a free DB from us. In that case, we mailed you your credentials with your donation confirmation. Questions? Please contact us.',
                    spTicketActive: '[TicketSystem] TicketSystem Advanced and Minimal. Manage your Tickets with a Web-Panel... [NEW]',
                    spTicketCommand: {
                    ...
                    spTicketLargeActive: '[WebInterface] Would you like to use a powerful webinterface to manage your tickets? [REQUIRE MySQL] [REQUIRE WEB][NEW]',
                    spTelegramActive: '[TelegramNotification] Notification via Telegram?',
                    spTelegramModeTicket: {
                        title: 'Ticket notification mode via Telegram',
                        options: {
                            always: 'Always',
                            when_no_supporter_online: 'When no supporter online',
                            never: 'Never'
                        }
                    },
                    ...
                    spDiscordActive: '[DiscordNotification] Notification via Discord? [GDPR] For this module, we will need to transmit personal data to our project servers, including the IP address of your server, a UUID and the message.',
                    spDiscordModeTicket: {
                    ...
                    spChannelEditActive: '[ChannelEdit] Edit your Channel',
                    spChanneleditInfoTutorial: 'The new ChannelEdit System. This module now works with a "parameter"! You can now open / close every channel with the command: <!offline> <parameter> IDEA: A example parameter is "ts" = "!online ts"',
                    ...
                    spChannelEdit: {
                        ...
                        vars: {
                            ...
                            spSupportChannelNameChange: 'The channel that should be renamed',
                            spSupportChannelSupporterId: 'Supporter Id\'s for selected Channel.',
                            ...
                            spSupportChannelKickActive: {
                                title: 'If a channel is closed, kick all waiting users? (only one)', // only one? <-- ??? O.o
                                options: {
                                    yes: 'Yes',
                                    no: 'No'
                                }
                    ...
                    spSupportChannelSupporterId: 'Default Supporter Id. Can change all channels.',
                    spAutomaticChannelManager: '[Automatic Channel Manager] Close and open your channel automatically',
                    spSupportChannelOpenAutomatic: 'The channel should open automatically, when supporters are online.',
                    spSupportChannelCloseAutomatic: 'The channel should close automatically, when no supporter is online or is afk.',
                    spTimeChannelManagerActive: '[Time Channel Manager] Close and open your channel by schedule',
                    spTimeZone: 'Select your time zone. Check the time with !time.',
                    spTimeChannelManager: {
                        title: 'Select your time',
                        vars: {
                            spTimePrefix: 'Your ChannelEdit parameter from the Module ChannelEdit! (*).',
                            spTime: 'Select the time for a action',
                            spTimeAction: {
                    ...
                    spQueueActive: '[Queue] Play music for waiting users...',
                    spQueueOwnActive: 'Use own Music / Soundfiles',
                    spQueueTrackOffline: {
                    ...
                    best_thanks_006mi4: '-> Special thanks for the professional sound records to 006mi4. Check out his website: https://vcircle.eu/',
                    spQueueText0: '[DE] Support Offline',
                    spSoundsOfflineGerman: {
                        FAQ_Musik: '[1] FAQ with Musik (02:17 min)',
                        Lite_DE: '[2] Lite (00:11 min)',
                        Lite_Dunkle_Stimme: '[3] Lite Dunkle Stimme (00:07 min)',
                        Lite_Helle_Stimme: '[4] Lite Helle Stimme (00:09 min)',
                        Lite_Langsame_Stimme: '[5] Lite Langsamme Stimme (00:09 min)',
                        Lite_Musik: '[6] Lite mit Musik (03:31 min)'
                    },
                    spQueueText1: '[DE] Support Online',
                    spSoundsOnlineGerman: {
                        FAQ_DE: '[7] FAQ ohne Musik (00:21 min)',
                        FAQ_Musik: '[8] FAQ mit Musik (02:16 min)',
                        Funny_EricCartman: '[9] Funny EricCartman (00:10 min)',
                        Funny_EricCartman_Musik: '[10] Funny EricCartman mit Musik (02:48 min)',
                        Lite_Mitarbeiter: '[11] Lite Employee (00:10 min)',
                        Lite_Mitarbeiter_Gespraech: '[12] Lite Employee Talk (00:05 min)',
                        Lite_Supporter: '[13] Lite Supporter (00:10 min)',
                        Lite_Supporter_Gespraech: '[14] Lite Supporter Talk (00:05 min)',
                        Lite_Supporter_Gespraech_Musik: '[15] Lite Supporter Talk Musik (02:41 min)'
                    },
                    spQueueText2: '[DE] Welcome',
                    spSoundsWelcomeGerman: {
                        Lite: '[16] Lite  (00:19 min)',
                        Regeln_Funny_Musik: '[17] Rules Funny Musik (01:38 min)',
                        Regeln_Happy: '[18] Rules Happy (00:14 min)',
                        Regeln_Happy_Musik: '[19] Rules Happy Musik (02:20 min)',
                        Regeln_Webseite_Musik_1: '[20] Rules Webseite Musik 1 (02:16 min)',
                        Regeln_Webseite_Musik_2: '[21] Rules Webseite Musik 2 (02:17 min)'
                    },
                    spQueueText3: '[EN] Support',
                    spSoundsOfflineEng: {
                        Lite: '[22] Lite Funny (00:11 min)',
                        Liste_Music: '[23] Lite Funny Music (03:55 min)'
                    },
                    spSelectMusic: {
                    ...
                    best_thanks_006mi4_2: '-> Special thanks for the professional sound records to 006mi4. Check out his website: https://vcircle.eu/',
                    spQueueVolume: 'Select the Volume:',
                    spQueueResume: 'Resume to last played track after queue track?',
                    spQueueMove: 'Move the bot to the Support Channel? (Buggy!)',
                    spAntiFloodActive: '[AntiFlood] AntiFlood Protection',
                    spAntiFloodInfo: 'This module will protect your ticket / support bot against flood. (WARNING: This module uses the internal storage.)',
                    spAntiFloodPointsReduce: 'Reduce points per minute',
                    spAntiFloodPointsLimit: 'Points to lock the user',
                    spAntiFloodPointsTicket: 'Points for each ticket',
                    spAntiFloodPointsSupport: 'Points for each support request',
                    spTopicNotificationActive: '[TopicNotification] Notify the topic supporter',
                    spTopic: {
                        title: 'Topic',
                        vars: {
                            spTopicName: 'Name of the topic',
                            spTopicId: 'ID of the topic',
                            spTopicSupporterGroups: 'Supporter Server-Group ID for the topic'
                        }
                    },
                    spTopicMessageSupporter: {
                        title: 'Message supporter [Variable &u = User, &thema = Topic]',
                        placeholder: 'Hey, the User &u needs support for topic &thema!'
                    },
                    spTopicMessageUser: {
                        title: 'Message User [Variable &u = User, &thema = Topic]',
                    ...
                    spPrefixActive: '[Prefix] Change the default prefix (e.g. Support |) (v2.0.0)',
                    ...
                    spFeedbackActive: '[Feedback] Get feedback after a support talk. [requires MySQL]',
                    spFeedbackQuestions: {
                    ...
                    msg_feedback_errorFeedbackSession: {
                        title: '[MSG] User pressed an forbidden key',
                    ...
                    spCopyright: 'This Script is created by VerHext (TypeScript Version by XeroxDev). This work is licensed under the Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License. Removal of any watermark / copyright notice is not permitted.'
                },
                system_messages: {
                    channeledit_kickreason: 'Der Supportchannel ist geschlossen.',
                    channeledit_all_closed: '[B]ChannelEdit | [/B] Alle Support Channel sind nun geschlossen.',
                    channeledit_all_open: '[B]ChannelEdit | [/B] Alle Support Channel sind nun geöffnet.',
                    channeledit_closed: '[B]ChannelEdit | [/B] Der Support Channel ist nun geschlossen.',
                    channeledit_open: '[B]ChannelEdit | [/B] Der Support Channel ist nun geöffnet.',
                    antiflood_blocked: '[color=#aa0000][b][Support++] Diese Aktion ist momentan nicht zuläassig aufgrund der Spam Protection. Versuche es in ein paar Sekunden erneut.[/b][/color]',
                    channeledit_no_permission_all: '[color=#aa0000][b][Support++] Du besitzt keine Berechtigung alle support Channel zu bearbeiten! Trage deine Server Id in das Feld: \'Default Supporter Id. Can change all Channel.\' [/b][/color]',
                    channeledit_no_permission: '[color=#aa0000][b][Support++] Du besitzt keine Berechtigung den Support Channel \'&channel\' zu bearbeiten! Trage deine Server Id in das Feld: \'Supporter Id\'s for selected Channel.\' [/b][/color]'
                }
            }
        }
    }
