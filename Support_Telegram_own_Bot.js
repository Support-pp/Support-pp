...
registerPlugin({
    ...
    vars: [{
        ...
        title: 'Ticket notification mode via own Telegram bot',
        type: 'select',
        options: ['Always', 'When no supporter online', 'Never']
    }, {
        name: 'spEmailModeSupport',
        title: 'Support notification mode own Telegram bot',
        type: 'select',
        options: ['Always', 'When no supporter online', 'Never']
    }, {
        name: 'spTelegramID',
        title: 'Telegram ChatId | https://github.com/VerHext/SinusbotScripts/wiki/You-own-Telegram-bot',
        placeholder: '123456789',
        type: 'string'
    }, {
        name: 'spTelegramToken',
        title: 'Telegram Bot token | https://github.com/VerHext/SinusbotScripts/wiki/You-own-Telegram-bot',
                    ...
                    if (SupporterOnline) {
                        ...
                        if (config.spEmailModeTicket == 0) {
                          sinusbot.http({
                                ...
                                url: "https://api.telegram.org/bot"+ config.spTelegramToken  + "/sendMessage?chat_id=" + config.spTelegramID + "&text=" + encodeURIComponent(spTelegrammTextSupport),
                                "timeout": 60000,
                            });
                            ...
                            if (SupporterOnline) {
                                ...
                                if (config.spEmailModeTicket == 0) {
                                  ...
                                  sinusbot.http({
                                      ...
                                      url: "https://api.telegram.org/bot"+ config.spTelegramToken  + "/sendMessage?chat_id=" + config.spTelegramID + "&text=" + encodeURIComponent(spTelegrammTextTicket),
                                      timeout: 60000,
                                  });
                                  engine.log('Telegram msg was sent....')
