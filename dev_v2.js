...
registerPlugin({
    ...
    vars: [{
        ...
        name: 'spChannelChangeTextOnline',
        title: 'Description of the Supportchannel (offline mode)',
        placeholder: 'Hello User, the support channel is Open!)',
        type: 'multiline'
    }, {
        name: 'spChannelChangeTextOffline',
        title: 'Description of the Supportchannel (offline mode)',
        placeholder: 'Hello User, the support channel is closed! \n\n Open every day from 10 a.m till 10 p.m \n\n But you can create a ticket with !t)',
        type: 'multiline'
    }, {
        ...
        name: 'spSupportChannelChangeAuto',
        title: 'Enable channel rename on a special time ?',
        type: 'select',
        options: ['Yes', 'NO']
      }, {
        name: 'spSupportChannelNameTimezone',
        title: 'Channel auto change Timezone. use the format: UTC-00:00',
                        ...
                        spSupporterId.forEach(function(group2) {
                            if (group.id() == group2) {
                                sinusbot.channelUpdate(config.spSupportChannelNameChange, {
                                    ...
                                    description: (config.spSupportChannelNameOfflineMsg)
                                });
                            }
                        })
                    })
                        ...
                        spSupporterId.forEach(function(group2) {
                            if (group.id() == group2) {
                                sinusbot.channelUpdate(config.spSupportChannelNameChange, {
                                    ...
                                    description: (config.spSupportChannelNameOnlinMsg)
                                });
                            }
                        });
                    });
